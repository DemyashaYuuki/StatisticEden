...
import com.artemis.the.gr8.playerstats.core.gui.listeners.StatsGuiListener;
...
public final class Main extends JavaPlugin implements PlayerStats {
    ...
    private static StatsGuiManager statsGuiManager;
    ...
    public void onEnable() {
        ...
        Bukkit.getPluginManager().registerEvents(new StatsGuiListener(statsGuiManager), this);
    ...
    private void initializeMainClassesInOrder() {
        ...
        statsGuiManager = new StatsGuiManager(threadManager);
    }
    ...
    private void registerCommands() {
        ...
        if (statcmd != null) {
            statcmd.setExecutor(new StatCommand(threadManager, statsGuiManager));
