# PlayerStats GUI Fork

This fork adds a Russian GUI browser for statistics, keeps the original chat commands, and targets Purpur/Paper 1.21.10 with optional SkinsRestorer support for player-head loading in the player selector GUI.

## Quick usage

- `/stat` — opens the GUI for players
- `/stat help` — shows help
- `/stat <old arguments>` — old command syntax still works
...
A GitHub Actions workflow is included under `.github/workflows/build.yml`.
